...
public class BigTriangleBlueAuto extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        shoot1 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(24.435, 84.455), new Pose(60.413, 81.909))
                )
        ...
        shoot2 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(24.672, 60.494), new Pose(60.413, 81.909))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(132))
                .build();
        ...
        shoot3 = follower.pathBuilder()
                .addPath(
                        new BezierLine(new Pose(24.174, 36.876), new Pose(71.644, 73.068))
                )
                .setLinearHeadingInterpolation(Math.toRadians(180), Math.toRadians(132))
                .build();
