...
//
//@Autonomous
//public class BBTCloseSlowAuto extends LinearOpMode {
...
//                .addPath(
//                        new BezierLine(new Pose(40.700, 87.000), new Pose(35.700, 87.000))
//                )
//                .setTangentHeadingInterpolation()
//                .addParametricCallback(0.2,()-> intakeMotor.intake_intake()).build();
//
//
//
//        intakeball2 = follower.pathBuilder()
//                .addPath(
//                new BezierLine(new Pose(35.700, 87.000), new Pose(30.700, 87.000)))
//                .setTangentHeadingInterpolation()
//                .build();
//
...
//                .addPath(
//                        new BezierLine(new Pose(25.700, 87.000), new Pose(60.400, 81.900))
//                )
